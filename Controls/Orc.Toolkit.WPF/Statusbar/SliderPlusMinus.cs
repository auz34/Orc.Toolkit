...
namespace Orc.Toolkit
{
    ...
    public class SliderPlusMinus : Slider
    {
        ...
        /// <summary>
        /// Initializes static members of the <see cref="SliderPlusMinus"/> class.
        /// </summary>
        static SliderPlusMinus()
        {
            DefaultStyleKeyProperty.OverrideMetadata(
                typeof(SliderPlusMinus), new FrameworkPropertyMetadata(typeof(SliderPlusMinus)));
        }
